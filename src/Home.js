  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // response = await fetch("http://localhost:9090/people", {
        //   mode: "cors",
        // });
                ...
                <Link to={"/detail/" + person.ID}>
                  ...
                  <div>
                    <img
                      ...
                      src={`${process.env.PUBLIC_URL}/${person.ImagePath}`}
                      alt="test"
                    />
                  </div>
                  <div
                    className={cx(styles.headerContainer, styles.colorWhite)}
                  >
